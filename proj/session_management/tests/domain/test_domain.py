...
from session_management.domain.exceptions import LecturerNotAssignedError, StreamMismatchError
...
def test_service_raises_when_stream_mismatch():
    ...
    # session will have a stream set by make_sample_session -> None; create with stream
    users = Mock()
    users.is_lecturer_active.return_value = True
